...
public class ReviewMapper {
    ...
    // 내부 Dto -> Entity
    public static Review toReviewEntity(CreateReviewInternalRequest request, UUID reservationId) {
        return new Review(
            request.userId(),
            request.lodgeId(),
            reservationId,
    ...
    // Entity -> 내부 Dto
    public static ReviewInternalResponse toReviewResponse(Review review) {
